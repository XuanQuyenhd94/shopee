...
create table routers (
	...
	names nvarchar(50) /*admin | nhân viên*/
)
/*router : 1 quản trị / nhân viên -> thêm sản phẩm / thêm hóa đơn / thêm danh mục / thêm nhóm hàng ... */
go
/*user - người dùng*/
create table users (
	...
	statuss bit default(0) /*được chấp nhận 1 | không thì nó là 0*/,
